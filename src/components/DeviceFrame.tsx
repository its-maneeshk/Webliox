      ...
      <div id="webhub-fullscreen-root" className="min-h-screen bg-bg-darkest text-[#e0e0e0] flex flex-col font-sans transition-all duration-300">
        ...
        <header className="flex items-center justify-between px-6 py-4 bg-bg-darker border-b border-white/10 sticky top-0 z-50">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-indigo-500 to-purple-600 flex items-center justify-center font-bold text-white shadow-md shadow-indigo-500/10 text-xs">
              W
            </div>
            <div>
          ...
          <div className="flex items-center gap-3">
            {selectedAppName && (
              <div className="flex items-center gap-2 bg-bg-card px-3.5 py-1.5 rounded-full border border-white/10 text-xs">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span>
                <span className="font-semibold text-slate-200">{selectedAppName}</span>
                <button 
                  onClick={onGoBack}
                  className="text-[11px] font-bold text-indigo-400 hover:text-indigo-300 ml-2 transition-colors cursor-pointer"
                  title="Close Website"
                >
                  Exit App
                </button>
            ...
            <button
              ...
              className="flex items-center gap-1.5 bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-[11px] px-3.5 py-2 rounded-xl transition-all cursor-pointer shadow-md shadow-indigo-500/10"
              title="Switch to Mobile Simulator"
            >
              <Smartphone size={13} />
        ...
        {/* Content body */}
        <main className="flex-1 w-full max-w-7xl mx-auto flex flex-col p-4 md:p-6">
          {children}
        </main>
      </div>
    );
      ...
      <main className="flex-1 grid grid-cols-12 overflow-hidden">
        ...
        <section className="col-span-6 bg-bg-darkest flex flex-col items-center justify-center relative p-4 overflow-y-auto custom-scrollbar">
          ...
          <div className="relative mx-auto w-[340px] h-[680px] rounded-[48px] border-[12px] border-bg-card bg-bg-darkest shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] flex flex-col overflow-hidden transition-all duration-300 border-white/10">
            ...
            {/* Android Status Bar */}
            <div className="h-10 bg-bg-darker px-5 pt-3.5 flex items-center justify-between text-slate-300 select-none z-[90] shrink-0 text-[10px] font-semibold">
            ...
            <div className="h-12 bg-bg-darker border-b border-white/5 px-4.5 flex items-center justify-between select-none z-50 shrink-0">
            ...
            <div className="h-9 bg-bg-darker flex items-center justify-around select-none z-50 shrink-0 pb-1 border-t border-white/5">
              <button 
                onClick={onGoBack || (() => {})} 
